...
% % %     end
    ...
    % Calculate first
    steady_state_number = calculate_N_steady_state(ms2_combined, slopes_array, mins_per_frame, forced_start_nc_time, intersct_array,...
        init_slope_length, half_width_max_rgn_ind, fluo_per_polymerase);
